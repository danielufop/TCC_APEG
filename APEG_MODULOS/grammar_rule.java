...
// on Quarta-feira, 15 de Março de 2017 at 19:53:15.
...
/**
 * Packrat parser for grammar <code>grammar_rule</code>.
 *
 * <p />This class has been generated by the <i>Rats!</i> parser
 * generator, version 2.4.0, (C) 2004-2014 Robert Grimm.
 */
public final class grammar_rule extends ParserBase {
  ...
  static final class grammar_ruleColumn extends Column {
    Chunk1 chunk1;
    Chunk2 chunk2;
    Chunk3 chunk3;
    Chunk4 chunk4;
   ...
   */
  public grammar_rule(final Reader reader, final String file) {
    super(reader, file);
  }
   ...
   */
  public grammar_rule(final Reader reader, final String file, final int size) {
   ...
   */
  public Result prules(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyRepetition1;
    boolean    yyRepeated1;
    Void       yyValue;
   ...
   * @throws IOException Signals an I/O error.
   */
  public Result pproduction(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyResult;
    int        yyOption1;
   ...
   * @throws IOException Signals an I/O error.
   */
  public Result pannotation(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyResult;
    Void       yyValue;
  ...
  private Result pSTRING_LITERAL(final int yyStart) throws IOException {
    grammar_ruleColumn yyColumn = (grammar_ruleColumn)column(yyStart);
  ...
  /**
   * Parse synthetic nonterminal grammar_rule.STRING_LITERAL$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse grammar_rule.STRING_LITERAL$$Star1. */
  ...
  /**
   * Parse synthetic nonterminal grammar_rule.LITERAL_CHAR$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal grammar_rule.ID$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse grammar_rule.ID$$Star1. */
  ...
  /**
   * Parse synthetic nonterminal grammar_rule.INT_NUMBER$$Plus1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse grammar_rule.INT_NUMBER$$Plus1. */
  ...
  /**
   * Parse synthetic nonterminal grammar_rule.EXPOENT$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result poptLocals(final int yyStart) throws IOException {
    grammar_ruleColumn yyColumn = (grammar_ruleColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.foptLocals) 
      yyColumn.chunk1.foptLocals = poptLocals$1(yyStart);
    return yyColumn.chunk1.foptLocals;
  }
  ...
  /**
   * Parse synthetic nonterminal grammar_rule.decls$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse grammar_rule.decls$$Star1. */
  ...
  /**
   * Parse synthetic nonterminal grammar_rule.peg_unary_op$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse grammar_rule.peg_unary_op$$Star1. */
  ...
  /**
   * Parse synthetic nonterminal grammar_rule.condExpr$$Plus1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse grammar_rule.condExpr$$Plus1. */
  ...
  /**
   * Parse synthetic nonterminal grammar_rule.or_cond$$Plus1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse grammar_rule.or_cond$$Plus1. */
  ...
  /**
   * Parse synthetic nonterminal grammar_rule.and_cond$$Plus1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse grammar_rule.and_cond$$Plus1. */
  ...
  /**
   * Parse synthetic nonterminal grammar_rule.aexpr$$Plus1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse grammar_rule.aexpr$$Plus1. */
  ...
  /**
   * Parse synthetic nonterminal grammar_rule.term$$Plus1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse grammar_rule.term$$Plus1. */
  ...
  /**
   * Parse synthetic nonterminal grammar_rule.actPars$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse grammar_rule.actPars$$Star1. */
